...
public class HcService extends Service {
    ...
    public void initBluetooth() {
        ...
        if (!isSupportBLE) {
            Toast.makeText(getBaseContext(), "Mobile phone not support BLE!",Toast.LENGTH_SHORT);
        } else {
    ...
    public void quicklyConnect() {
        if (mAdapter != null) {
            if (mAdapter.isEnabled()) {
               ...
               Toast.makeText(getBaseContext(), "Please enable the mobile phone's bluetooth!",Toast.LENGTH_SHORT);
            }
        }
    }
