...
public class App extends Application {
    ...
    public final static boolean isUseCustomBleDevService2 = false;
    ...
    public void onCreate() {
        ...
        //在Application初始化CssServerApi，不使用Mintti服务器进行数据同步的话，就不需要在此初始化CssServerAp。
//   accPrefix= "zydb_"： AndroidManifest.xml中设置的appKey&appSecret所对应的账号前缀
//        每组appKey&appSecret都有自己对应的accPrefix,具体什么值由Mintti服务器组决定并定义。
