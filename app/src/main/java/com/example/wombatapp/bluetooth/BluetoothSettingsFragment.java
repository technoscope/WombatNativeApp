...
import com.example.wombatapp.utils.ColorUtil;
import com.example.wombatapp.utils.PermissionHelper;
...
public class BluetoothSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        context = getContext();
        openScale=new OpenScale(context);
                ...
                notSupported.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        notSupportedIntent.setData(
                                Uri.parse("https://devomech.com/contact-us/"));
    ...
    private void getDebugInfo(final BluetoothDevice device) {
        ...
        builder.setTitle("Fetching info")
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        openScale.disconnectFromBluetoothDevice();
                        dialog.dismiss();
                    }
                });
        ...
        stopBluetoothDiscovery();
        openScale.connectToBluetoothDeviceDebugMode(macAddress, btHandler);
    }
