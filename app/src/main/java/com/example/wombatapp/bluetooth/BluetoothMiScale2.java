...
import com.example.wombatapp.utils.Converters;
...
import static com.example.wombatapp.bluetooth.BluetoothCommunication.BT_STATUS.UNEXPECTED_ERROR;
    ...
    protected boolean onNextStep(int stepNr) {
        switch (stepNr) {
            case 0:
                ...
                byte[] setUnitCmd = new byte[]{(byte)0x06, (byte)0x04, (byte)0x00, (byte) 1};
        ...
        try {
            ...
            if (isStabilized && !isWeightRemoved && !isDateInvalid) {
             ...
             //      final ScaleUser scaleUser = OpenScale.getInstance().getSelectedScaleUser();
                    ...
                    Toast.makeText(context, "Weight is ="+String.valueOf(weight)+" kg", Toast.LENGTH_SHORT).show();
                    scaleBtData.setWeight(Converters.toKilogram(weight, Converters.WeightUnit.KG)); //,scaleUser.getScaleUnit()));
               ...
               //         sex = 1;
                 //   } else {
                   //     sex = 0;
                    ...
                    if (impedance != 0.0f) {
                        MiScaleLib miScaleLib = new MiScaleLib(1, 24, 70);
